...
##################################################################################################################################
########## EXPLORE outputs 
interv_senegal <- read.csv("fits_interv/senegal2472500.csv")[,-1]
interv_england <- read.csv("fits_interv/england2732500.csv")[,-1]
interv_denmark <- read.csv("fits_interv/denmark2212500.csv")[,-1]
